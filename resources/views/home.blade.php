...
<section class="hero overflow-hidden">
    <div class="shell grid items-center gap-14 py-16 lg:grid-cols-[1.02fr_.98fr] lg:py-24">
        <div>
            <div class="eyebrow"><span></span>Medication care, kept human</div>
            <h1>Every dose.<br><em>Gently on track.</em></h1>
            <p class="hero-copy">NexPill brings reminders, refill tracking, appointments and family support into one calm daily routine—without turning care into a spreadsheet.</p>
            ...
            <div class="trust-row"><span class="avatar-stack"><i>AM</i><i>RJ</i><i>SK</i></span><span><strong>Designed around real routines</strong><small>Clear, private, family-friendly</small></span></div>
        </div>
...
<section class="cta-section"><div class="shell"><div class="cta-card"><div><span class="section-kicker">Ready when you are</span><h2>Make medication care feel lighter.</h2><p>Join early access and help shape a safer, calmer NexPill experience.</p></div><a class="button button-coral" href="{{ route('support') }}">Request early access</a></div></div></section>
@endsection
