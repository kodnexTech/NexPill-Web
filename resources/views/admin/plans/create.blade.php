    ...
    <div class="rounded-2xl border border-[#DCE6F2] bg-white p-8 shadow-sm">
        <form method="POST" action="{{ route('admin.plans.store') }}" class="space-y-5">
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                    <label class="mb-1.5 block text-sm font-semibold text-[#10233F]">Price (in paise/cents) <span class="text-red-500">*</span></label>
                    <input name="price_minor" type="number" value="{{ old('price_minor', 0) }}" min="0" required
                        class="w-full rounded-xl border border-[#DCE6F2] bg-[#F4FAFF] px-4 py-3 text-sm focus:border-[#075DE7] focus:outline-none focus:ring-2 focus:ring-[#075DE7]/15"
                        placeholder="e.g. 49900 = ₹499">
                    <p class="mt-1 text-xs text-[#5B6D86]">In minor units (e.g. 49900 = ₹499.00)</p>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="features" rows="5"
                        class="w-full rounded-xl border border-[#DCE6F2] bg-[#F4FAFF] px-4 py-3 text-sm focus:border-[#075DE7] focus:outline-none focus:ring-2 focus:ring-[#075DE7]/15 resize-none"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <label for="is_active" class="text-sm font-medium text-[#10233F]">Active (visible to users)</label>
                </div>
            </div>
