    ...
    <div class="rounded-2xl border border-[#DCE6F2] bg-white p-8 shadow-sm">
        <form method="POST" action="{{ route('admin.legal.store') }}" class="space-y-5">
            ...
            <div class="grid gap-5 sm:grid-cols-3">
                <div>
                    <label class="mb-1.5 block text-sm font-semibold text-[#10233F]">Type <span class="text-red-500">*</span></label>
                    <select name="type" class="w-full rounded-xl border border-[#DCE6F2] bg-[#F4FAFF] px-4 py-3 text-sm focus:border-[#075DE7] focus:outline-none">
                ...
                <div>
                    <label class="mb-1.5 block text-sm font-semibold text-[#10233F]">Version <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="mb-1.5 block text-sm font-semibold text-[#10233F]">Content (HTML or plain text) <span class="text-red-500">*</span></label>
                <textarea name="content" rows="20" required
                    class="w-full rounded-xl border border-[#DCE6F2] bg-[#F4FAFF] px-4 py-3 text-sm font-mono focus:border-[#075DE7] focus:outline-none focus:ring-2 focus:ring-[#075DE7]/15 resize-y">{{ old('content') }}</textarea>
